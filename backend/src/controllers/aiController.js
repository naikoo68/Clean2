...
const TYPES = ["mcq", "matching", "statement", "pair", "pairselect", "assertion", "table", "journal", "ledger"];
...
const ANSWER_DEDUP_TYPES = new Set(["mcq", "table", "journal", "ledger"]);
...
- "type": one of "mcq", "matching", "statement", "pair", "pairselect", "assertion", "table", "journal", "ledger".
