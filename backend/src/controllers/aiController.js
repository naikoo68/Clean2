...
const TYPES = ["mcq", "matching", "statement", "pair", "pairselect", "assertion", "table", "journal", "ledger", "rearrange"];
...
const ANSWER_DEDUP_TYPES = new Set(["mcq", "table", "journal", "ledger", "rearrange"]);
...
- "type": one of "mcq", "matching", "statement", "pair", "pairselect", "assertion", "table", "journal", "ledger", "rearrange".
...
- "rearrange": a SENTENCE / PARAGRAPH REARRANGEMENT (jumbled-sentence ordering) question. In "text", write the instruction and then the FOUR jumbled sentences each LABELLED with a Roman numeral in the fixed order I, II, III, IV — for example: "Rearrange the following sentences to form a meaningful paragraph: I. <sentence one>. II. <sentence two>. III. <sentence three>. IV. <sentence four>." The 4 "options" are FOUR candidate ORDERINGS of those four labels, written as Roman numerals joined by hyphens (e.g. "IV-II-I-III", "I-IV-III-II", "IV-I-II-III", "I-IV-II-III"). EXACTLY ONE option is the correct logical order; the other three are plausible but wrong orders (do NOT make them obviously silly). In "explanation", state the correct sequence and WHY it flows — which sentence must OPEN the paragraph (usually the one that introduces the subject/sets the context; a sentence that starts with a pronoun like "He/It/This" cannot open because its subject isn't introduced yet), how each sentence logically follows the previous one, and which sentence CONCLUDES it. The 4 "optionExplanations" each say why that specific ordering is right or wrong (e.g. "puts the conclusion (III) before the cause (II)", or "opens with a pronoun before the subject is named"); leave the correct option's entry an empty string "". Keep "numerical": false.
