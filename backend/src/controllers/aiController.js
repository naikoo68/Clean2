...
MORE ILLUSTRATION KINDS (same "illustration" object): data table (payoff matrix, balance sheet, ledger, trial balance, stem-and-leaf) → {"kind":"table","headers":["","Left","Right"],"rows":[["Up","3, 3","0, 5"],["Down","5, 0","1, 1"]]}. Vector/slope field → {"kind":"field","type":"vector"} or "slope". Mitosis/meiosis → {"kind":"celldivision","process":"mitosis"} (or "meiosis"). Human body systems → {"kind":"humanbody"}. Periodic table (optionally highlight symbols) → {"kind":"periodictable","highlight":["Na","Cl"]}. Reaction mechanism (stepwise: reactant → intermediate/transition state → product; wrap a transition state in square brackets to style it dashed) → {"type":"reactionmechanism","illustration":{"kind":"mechanism","species":["CH₃Br","[HO···CH₃···Br]","CH₃OH"],"conditions":["OH⁻","− Br⁻"],"notes":["slow (rate-determining)","fast"]}} (conditions label each arrow, notes go below each arrow). Fishbone/Ishikawa → {"kind":"fishbone","effect":"Problem","causes":[{"category":"People","items":["..."]}]}. Flashcards → {"kind":"flashcards","cards":[{"front":"Q","back":"A"}]}. Kanban/roadmap use a framework grid: {"type":"kanban","framework":{"kind":"grid","cols":3,"cells":[{"title":"To Do","items":["..."]}]}}.
