...
export async function updateSettings(req, res) {
  ...
  const allowed = [
    ...
    "watermarkEnabled", "watermarkText", "watermarkOpacity", "watermarkSize", "watermarkMode", "restrictCopy", "screenshotGuard", "guardHoldMs", "statsAuto",
    "notifyOnNewContent", "notifyEmailAdmin", "notifyEmailStudents", "notifyNoticeBoard",
    "homeSections",
    "clientAnnouncement",
    "onboardingCompleted",
