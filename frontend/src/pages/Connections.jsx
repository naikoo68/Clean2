        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <button onClick={() => setShowInstall((s) => !s)} className="btn-primary">
                <Download className="h-4 w-4" /> Install Companion
              </button>
            </div>
          </div>
        </div>
        ...
        {showInstall && (
          <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm dark:border-slate-700 dark:bg-slate-800/60">
            ...
            <ol className="mt-2 list-decimal space-y-1 pl-5 text-slate-600 dark:text-slate-300">
              <li>Download the <code>extension</code> folder from the My Study Guide repository.</li>
              <li>Open your browser's Extensions page and turn on <b>Developer mode</b>.</li>
